...
$(document).ready(function() {
  ...
  $("#tdl8").keyup(function(){
    ...
    setTimeout(function(){
        ...
        map = L.map('map').setView([2.378347117326855,102.21933579587713], 14);
        ...
        customer.addTo(map);
         ...
         dp = L.tileLayer.wms("http://121.121.232.54:7090/geoserver/cite/wms", {
            layers: 'cite:demand_point_without_meter_number1',
            format: 'image/png',
             maxZoom: 20,
            transparent: true
        });
        ...
        dp2 = L.tileLayer.wms("http://121.121.232.54:7090/geoserver/cite/wms", {
            layers: 'cite:demand_point_with_meter_number1',
            format: 'image/png',
            maxZoom: 20,
            transparent: true
        });
            ...
            success: function callback(data) {
                ...
                if(data.features.length==0){
                    ...
                    if(layer=='customer'){
                        ...
                        $("#tdr3").html(data.features[0].properties.assb_house_no);
                        $("#tdr4").html(data.features[0].properties.street);
                        $("#tdr5").html(data.features[0].properties.assb_address);
                        $("#tdr6").html(data.features[0].properties.equipment);
